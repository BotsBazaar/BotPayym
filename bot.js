...
var bot_token = '5595807431:AAGcd3-Yztal8bgtCgRHuezfUcwuJFPEvQo'; //YOUR BOT TOKEN HERE
var bot_name = 'Paisaa_Walaa_Bot'; // Bot Name
...
const admin_id = 1277524836;
const admin_id2 = 1277524836;
var mongo_url = 'mongodb+srv://GAURAV:g1g2g3g4@cluster0.bynii.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'; // Your Mongo URL Here
const buttonsLimit = {
    window: 1000,
    limit: 1,
        ...
        if (bots == 'Active') {
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n✅ Created By : <a href="tg://user?id=1277524836">Gaurav</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['👫 Invite', '🎁 Bonus', '🗂 Wallet'], ['💵 Withdraw', '📊 Statistics']], resize_keyboard: true } }
                    )
                } else {
      ...
      return 0;
        ...
        ctx.replyWithMarkdown( 
            ...
            bot.telegram.sendMessage(pay, "<b>✅ New Withdrawal Requested ✅\n\n🟢 User : <a href='tg://user?id=" + ctx.from.id + "'>" + ctx.from.id + "</a>\n\n🚀Amount : " + toWith + " " + currency + "\n⛔ Address :</b> <code>" + wallet + "</code>\n\n<b>💡 Bot: @" + ctx.botInfo.username + "</b>", { parse_mode: 'html' })
             ...
             let amount = toWith
             let url = "https://payouts.crazycamps.xyz/bfitech.php?number="+wallet+"&amount="+amount+"&comment="+comment+"&guid="+swg+"";
             axios.post(url);
    }
    await ctx.scene.leave('onWithdraw')
  } catch(err) {
